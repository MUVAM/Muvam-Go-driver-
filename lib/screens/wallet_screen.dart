...
import 'package:muvam_rider/screens/how_to_withdraw.dart';
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    final transactions = [
                      {'amount': 'Withdrawal', 'dateTime': 'Dec 15, 2024 • 2:30 PM', 'status': '-₦500', 'color': Colors.black},
                      {'amount': 'Credit', 'dateTime': 'Dec 14, 2024 • 10:15 AM', 'status': '+₦1,200', 'color': Colors.black},
                      {'amount': 'Withdrawal', 'dateTime': 'Dec 13, 2024 • 6:45 PM', 'status': '-₦1,200', 'color': Colors.black},
                      {'amount': 'Credit', 'dateTime': 'Dec 12, 2024 • 1:20 PM', 'status': '+₦1,200', 'color': Colors.black},
                    ];
